...
import org.litespring.aop.framework.JDKProxyFactory;
...
import org.litespring.test.v5.AbstractV5Test;
...
public class JDKProxyFactoryTest extends AbstractV5Test {
    ...
    public void setUp() throws Exception {
        ...
        pc.setExpression("execution(* org.litespring.service.v6.*.placeOrder(..))");
        TransactionManager tx = new TransactionManager();
        factory = (DefaultBeanFactory) this.getBeanFactory("petstore-v6.xml");
    ...
    public void testProxy() {
        ...
        AopProxyFactory factory = new JDKProxyFactory(config);
        IPetstoreService proxy = (IPetstoreService) factory.getProxy();
